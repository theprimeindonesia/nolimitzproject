...
class UlasanBlogsController extends Controller
{
    public function createUlasanBlogs(Request $request, $blogid)
    {
        ...
        $ulasanBlogs->members_id = $request->members_id; // set ulasan blogs members
    ...
    public function updateUlasanBlogs(Request $request, $ulasanblogid)
    {
        ...
        if($members_id==$request->members_id){ //statment jika member yang update ulasan blog adalah member yang sesuai maka pesan ulasan blogs dapat di update
    ...
    public function createBalasUlasanBlogs(Request $request, $ulasanblogid)
    {
        ...
        $balasUlasanBlogs->members_id = $request->members_id; // set balas ulasan blogs members
    ...
    public function updateBalasUlasanBlogs(Request $request, $balasulasanblogid)
    {
        ...
        if($members_id==$request->members_id){ //statment jika member yang update ulasan blog adalah member yang sesuai maka pesan balas ulasan blogs dapat di update
