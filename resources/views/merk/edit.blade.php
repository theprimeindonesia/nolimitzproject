		...
		<div class="panel-body">
			<div class="col-md-12 col-lg-12">
				<div class="example-wrap">
					...
					@endif
					<div class="example">
						{!! Form::model($data, ['class' => 'form-horizontal','enctype' => 'multipart/form-data','method' => 'PATCH','route' => ['merk.update', $data->merk_id]]) !!}
                        {{method_field('PATCH')}}
						@csrf
						<div class="form-group row">
							<label class="col-md-3 form-control-label">Images: </label>
							<div class="col-md-9">
								<img src="{{ url('/images/merk/',$data['image'])}}" width='200px;'>
