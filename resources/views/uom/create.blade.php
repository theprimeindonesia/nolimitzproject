		...
		<div class="panel-body">
			<div class="col-md-12 col-lg-12">
				<div class="example-wrap">
					...
					@endif
					<div class="example">
						<form class="form-horizontal" method="POST" action="{{ route('uom.store') }}" enctype="multipart/form-data"> 
						@csrf
							<div class="form-group row">
								<label class="col-md-3 form-control-label">Name: </label>
								<div class="col-md-9">
									<input type="text" class="form-control" name="name" placeholder="Unit of Measure Name" autocomplete="off"
									/>
								</div>
							</div>
							<div class="form-group row">
