...
<div class="page-content">
	<div class="panel panel-bordered">
		<div class="panel-heading">
			<h3 class="panel-title">Create New Payment</h3>
		</div>
		<div class="panel-body">
			<div class="col-md-12 col-lg-12">
				<div class="example-wrap">
					...
					@endif
					<div class="example">
						<form class="form-horizontal" method="POST" action="{{ route('payments.store') }}" enctype="multipart/form-data"> 
						@csrf
							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									<div class="input-group input-group-file" data-plugin="inputGroupFile">
										<input class="form-control" readonly="" name="image" type="text">
