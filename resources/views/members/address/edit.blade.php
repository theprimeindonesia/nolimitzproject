...
<div class="page-content container-fluid">
    <form action="{{route('members.address.update',$data['addresses_id'])}}" method="post" id="formVarian" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body container-fluid">
                        <div class="row row-lg">
                            ...
                            <div class="col-md-6">
                                <h4 class="example-title">Subdistrict </h4>
                                <div class="example">
                                    <input type="text" name="subdistrict" class="form-control" value="{{$data['subdistrict']}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h4 class="example-title">Province</h4>
                                <div class="example">
