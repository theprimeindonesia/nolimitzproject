...
{!! Form::model($data, ['class' => 'form-horizontal','enctype' => 'multipart/form-data','method' => 'PATCH','route' => ['members.update', $data->members_id]]) !!}
    {{method_field('PATCH')}}
    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="example">
                            <div class="input-group">
                                ...
                                <input type="text" name="tanggal_lahir" class="form-control" id="tanggal" data-plugin="datepicker"  value="{{$data['tanggal_lahir']}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="example">
                            <div class="form-group">
                                <div class="input-group input-group-file" data-plugin="inputGroupFile">
                                    <input type="text" class="form-control" readonly="" value="{{$data['photo']}}">
                            ...
                            <hr/>
                            <img src="{{url('/public/images/photo',$data->photo)}}" width="150" height="150">
                        </div>
                    </div>
                </div>
            </div>
