...
<div class="page-content container-fluid">
    <form action="{{route('members.bank.update',$data['member_bank_id'])}}" method="post" id="formVarian" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-body container-fluid">
                        <div class="row row-lg">
                            <div class="col-md-6">
                                ...
                                <div class="example">
                                    <input type="text" name="owner" class="form-control" value="{{$data['owner']}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="example">
                                    <input type="text" name="no_account" class="form-control" value="{{$data['no_account']}}">
                                    <input type="hidden" name="members_id" class="form-control" value="{{$data['members_id']}}">
                                </div>
                            </div>
                        </div>
                    </div>
