...
<div class="page-header">
    <h1 class="page-title">Add Varian Product</h1>
    <a href="{{route('product.detail',$id)}}" class="btn btn-success"> <i class="icon wb-arrow-left" aria-hidden="true"></i> Back</a>
</div>
<div class="page-content container-fluid">
    <form action="{{route('product.varian.save',$data->stock_id)}}" method="post" id="formVarian" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="example">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" placeholder="" type="text" name="primary"  id="primary">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="example">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" placeholder="" type="text" name="secondary"  id="secondary">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="example">
                                <input type="text" value="" data-id="{{$v['name']}}"  id="dynVarian" class="form-control" >
                            </div>
                        </div>
                        @endforeach
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="example">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="" type="text" name="weight"  id="weight">
                                        <div class="input-group-prepend">
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="example">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="" type="text" name="height"  id="height">
                                        <div class="input-group-prepend">
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="example">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="" type="text" name="length"  id="length">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Cm </span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="example">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="" type="text" name="width"  id="width">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Cm </span>
                                        </div>
                                    </div>
