    ...
    <div class="panel panel-bordered">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-15">
                        <a href="{{ route('suppliers.create') }}" class="btn btn-outline btn-primary">
            ...
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                ...
                @php($i = 1)
                    ...
                    <tr>
                        ...
                        <td>{{ $x->name }}</td>
                        <td>{{ $x->contact }}</td>
                        <td>{{ $x->contact_sales }}</td>
                        <td>
                            <a href="{{ route('suppliers.edit', $x->suppliers_id) }}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"><i class="icon wb-edit" aria-hidden="true"></i></a>
                            <form id="remove-user" action="{{ route('suppliers.destroy', $x->suppliers_id) }}" method="POST" style="display: inline-block;">
                                {{method_field('DELETE')}}
                                @csrf
