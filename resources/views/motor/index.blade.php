...
<div class="page-content">
    <div class="panel panel-bordered">
        <div class="panel-heading">
            <h3 class="panel-title">Product Motor Management</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-15">
                        <a href="{{ route('motor.create') }}" class="btn btn-outline btn-primary">
                        <i class="icon wb-plus" aria-hidden="true"></i> Add New Motor
                        </a>
                    </div>
                </div>
            </div>
                ...
                @php($i = 1)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form id="remove-user" action="{{ route('motor.destroy', $data->motor_id) }}" method="POST" style="display: inline-block;">
                                {{method_field('DELETE')}}
                                @csrf
