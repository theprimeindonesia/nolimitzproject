...
<div class="page-content">
    <div class="panel panel-bordered">
        <div class="panel-heading">
            <h3 class="panel-title">Expedition Management</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-15">
                        <a href="{{ route('expeditions.create') }}" class="btn btn-outline btn-primary">
                        <i class="icon wb-plus" aria-hidden="true"></i> Add New Expedition
                        </a>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                ...
                @php($i = 1)
                    ...
                    <tr>
                        ...
                        <td>{{ $data->type }}</td>
                        <td>
                            <a href="{{ route('expeditions.edit', $data->expeditions_id) }}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"><i class="icon wb-edit" aria-hidden="true"></i></a>
                            <form id="remove-user" action="{{ route('expeditions.destroy', $data->expeditions_id) }}" method="POST" style="display: inline-block;">
                                {{method_field('DELETE')}}
                                @csrf
